...
public class NoticeBoardImg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String qr="select * from imgnotices where uid=?";
            ...
            while(rs.next()){
                ...
                out.println("<td><img width=100 height=100 src=\"ImageLoader?id="+s1+"\"></td>");
                out.println("</tr>");
                out.println("</tr>");
                out.println("<tr>");
            ...
            out.println("</table>");
            out.println("<hr>");
            out.println("<a href=ShowDeptsImg>Dept-List</a>");
